...
TOTAL_FRAMES       = 10_000_000  # total training frames
...
PLOT_EVERY         = 50          # save plots every N updates
...
def _smooth(values, window=20):
    """Simple rolling average for smoother curves."""
...
def save_plots(history: dict, plot_dir: str):
    """Save training curve plots to plot_dir."""
